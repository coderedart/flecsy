...
#[allow(unsafe_code)]
pub const ECS_BLACK: &::std::ffi::CStr =
    unsafe { ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"\x1B[1;30m\0") };
#[allow(unsafe_code)]
pub const ECS_RED: &::std::ffi::CStr =
    unsafe { ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"\x1B[0;31m\0") };
#[allow(unsafe_code)]
pub const ECS_GREEN: &::std::ffi::CStr =
    unsafe { ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"\x1B[0;32m\0") };
#[allow(unsafe_code)]
pub const ECS_YELLOW: &::std::ffi::CStr =
    unsafe { ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"\x1B[0;33m\0") };
#[allow(unsafe_code)]
pub const ECS_BLUE: &::std::ffi::CStr =
    unsafe { ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"\x1B[0;34m\0") };
#[allow(unsafe_code)]
pub const ECS_MAGENTA: &::std::ffi::CStr =
    unsafe { ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"\x1B[0;35m\0") };
#[allow(unsafe_code)]
pub const ECS_CYAN: &::std::ffi::CStr =
    unsafe { ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"\x1B[0;36m\0") };
#[allow(unsafe_code)]
pub const ECS_WHITE: &::std::ffi::CStr =
    unsafe { ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"\x1B[1;37m\0") };
#[allow(unsafe_code)]
pub const ECS_GREY: &::std::ffi::CStr =
    unsafe { ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"\x1B[0;37m\0") };
#[allow(unsafe_code)]
pub const ECS_NORMAL: &::std::ffi::CStr =
    unsafe { ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"\x1B[0;49m\0") };
#[allow(unsafe_code)]
pub const ECS_BOLD: &::std::ffi::CStr =
    unsafe { ::std::ffi::CStr::from_bytes_with_nul_unchecked(b"\x1B[1;49m\0") };
...
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum ecs_query_cache_kind_t {
...
impl ecs_type_kind_t {
    pub const EcsTypeKindLast: ecs_type_kind_t = ecs_type_kind_t::EcsOpaqueType;
}
#[repr(u32)]
#[doc = " Type kinds supported by meta addon"]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum ecs_type_kind_t {
    EcsPrimitiveType = 0,
    EcsBitmaskType = 1,
    EcsEnumType = 2,
    EcsStructType = 3,
...
impl ecs_primitive_kind_t {
    pub const EcsPrimitiveKindLast: ecs_primitive_kind_t = ecs_primitive_kind_t::EcsId;
}
#[repr(u32)]
#[doc = " Primitive type kinds supported by meta addon"]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum ecs_primitive_kind_t {
    EcsBool = 1,
    EcsChar = 2,
    EcsByte = 3,
    EcsU8 = 4,
...
impl ecs_meta_type_op_kind_t {
    pub const EcsMetaTypeOpKindLast: ecs_meta_type_op_kind_t = ecs_meta_type_op_kind_t::EcsOpId;
}
#[repr(u32)]
...
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum ecs_meta_type_op_kind_t {
    EcsOpArray = 0,
    EcsOpVector = 1,
    EcsOpOpaque = 2,
    EcsOpPush = 3,
...
extern "C" {
    ...
    pub fn tmpnam(arg1: *mut [::std::os::raw::c_char; 20usize]) -> *mut ::std::os::raw::c_char;
    pub fn tmpnam_r(__s: *mut [::std::os::raw::c_char; 20usize]) -> *mut ::std::os::raw::c_char;
    pub fn tempnam(
    ...
    pub fn ecs_init_w_args(
        ...
        argv: *mut [*mut ::std::os::raw::c_char; 0usize],
    ) -> *mut ecs_world_t;
